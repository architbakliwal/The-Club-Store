    ...
    <div data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="heading media dropdown-toggle">      
      <div class="cart-inner media-body">
        <a>
          <i class="icon-cart"></i>
          <div class="wrap-cart">
            <span class="text-cart"><?php echo $objlang->get("text_shopping_cart"); ?></span><br>
      ...
      <li>
        <div class="table-responsive">
          ...
          <p class="text-center view-cart">
            <a href="<?php echo $cart; ?>" class="btn btn-primary btn-block">
              <?php echo $text_cart; ?>
            </a>
          </p>
          <p class="text-center  view-cart">
            <a href="<?php echo $checkout; ?>" class="btn bg-black btn-block">
