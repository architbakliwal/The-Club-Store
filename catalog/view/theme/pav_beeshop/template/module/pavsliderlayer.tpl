...
<?php } ?>
	<div class="fix-margin-right hidden-xs hidden-sm" style="padding: <?php echo $sliderParams['padding'];?>;margin: <?php echo $sliderParams['margin'];?>;">
		<div id="iview" style="width:100%;height:<?php echo $sliderParams['height'];?>px; " >
